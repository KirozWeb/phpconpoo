...
if($_POST['r'] == 'user-edit' && $_SESSION['role'] == 'Admin' && !isset($_POST['crud'])) {
    ...
    if( empty($user)){
        ...
        $roel_user = ($user[0]['role'] == 'User') ? 'checked' : '';
        $template_user = '
            <h2 class="p1">Editar Usuario</h2>
            <form method="POST" class="item">
                <div class="p_25">
                    <input type="text" placeholder="usuario" value="%s"
                        disabled required>
                ...
                <div class="p_25">
                    <input type="text" name="birthday" placeholder="cumpleaños"
                    value="%s" required>
                </div>
                <div class="p_25">
                ...
                <div class="p_25">
                    <input type="radio" name="role" id="admin" value="Admin" %s required><label 
                    for="admin">Administrador</label>
                    <input type="radio" name="role" id="noadmin" value="User" %s required><label 
                    for="noadmin">Usuario</label>
                </div>
                <div class="p_25">
