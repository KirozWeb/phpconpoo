...
if($_POST['r'] == 'movieserie-edit' && $_SESSION['role'] == 'Admin' && !isset($_POST['crud'])) {
    ...
    if( empty($ms)){
        ...
        $status_select = '';
         ...
         for($n=0; $n < count($status); $n++){
            ...
            $selected = ($ms[0]['estado_'] == $status[$n]['estado_']) ? 'selected' : '';

            $status_select .= '<option value="' . $status[$n]['estado_id'] . '"' . $selected . '>' .
        ...
        $template_ms = '
            ...
            <div class="p_25">
                <input type="text" name="imdb_id" placeholder="imdb_id" value="%s" disabled required>
            ...
            <div class="p_25">
                <input type="text" name="author" placeholder="author" value="%s">
            </div>
            <div class="p_25">
            ...
            <div class="p_25">
                <input type="radio" name="category" id="movie" value="Movie" %s required><label 
                for="movie">Movie</label>
                <input type="radio" name="category" id="serie" value="Serie" %s required><label 
    ...
    print('<h2>Esto es dentro de movieseries-edit</h2>');
